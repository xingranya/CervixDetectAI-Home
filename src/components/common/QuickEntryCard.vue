...
<template>
  <RouterLink class="quick-entry-card" :to="to">
    <div class="quick-entry-card__icon" :data-icon="shortLabel" aria-hidden="true">
      ...
      <svg v-else-if="shortLabel === '方向'" viewBox="0 0 24 24" class="quick-entry-card__svg">
      ...
      <svg v-else-if="shortLabel === '成果'" viewBox="0 0 24 24" class="quick-entry-card__svg">
        <circle cx="12" cy="9" r="4.5" />
        <path d="M9.2 13.2 7.5 20l4.5-2.4 4.5 2.4-1.7-6.8" />
        <path d="M8.6 4.8H5.5v4.2l2.4 1.4M15.4 4.8h3.1v4.2l-2.4 1.4" />
      </svg>

      <svg v-else-if="shortLabel === '动态'" viewBox="0 0 24 24" class="quick-entry-card__svg">
        <path d="M4 12h3.5l2-4 3.2 8 2.1-5H20" />
        <path d="M5 18h14" />
        <path d="M5 6h5" />
      </svg>

      <svg v-else-if="shortLabel === '合作'" viewBox="0 0 24 24" class="quick-entry-card__svg">
      ...
      <svg v-else-if="shortLabel === '入口'" viewBox="0 0 24 24" class="quick-entry-card__svg">
      ...
      <svg v-else-if="shortLabel === '资料'" viewBox="0 0 24 24" class="quick-entry-card__svg">
        <path d="M7 4.5h7l3 3V19.5H7z" />
        <path d="M14 4.5v3h3" />
        <path d="M9.5 11h5M9.5 14h5M9.5 17h3.5" />
      </svg>

      <svg v-else viewBox="0 0 24 24" class="quick-entry-card__svg">
